...
public:
    ...
    public:
        ...
        EdgeList outEdges() const {
            ...
            return EdgeList(edges, g.edgeMap);
        }
    ...
    public:
        ...
        Vertex& origin() {
            return g.vertexMap.at(startVertex);
        }

        Vertex& dest() {
            return g.vertexMap.at(endVertex);
        }
    ...
    private:
        ...
        Edge(const EdgeElement& _element, int _id, int _startVertex, int _endVertex, bool _directed, Graph& _g) :
            element(_element), id(_id), startVertex(_startVertex), endVertex(_endVertex), directed(_directed), g(_g) {}
    };
...
private:
    ...
    Edge& insertEdge(const Vertex& v, const Vertex& u, const EdgeElement& element, bool directed) {
        ...
        Edge e(element, nextEdgeID++, v.id, u.id, directed, *this);
